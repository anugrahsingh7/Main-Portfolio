            ...
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-[#ffe5d5] rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                <div className="flex-1">
                  <label className="block mb-2 text-lg font-bold text-black">Full Name</label>
                  <input
                    type="text"
                ...
                <div className="flex-1 mt-6">
                  <label className="block mb-2 text-lg font-bold text-black">Email address</label>
                  <input
                    type="email"
                ...
                <div className="w-full mt-6">
                  <label className="block mb-2 text-lg font-bold text-black">Message</label>
                  <textarea
