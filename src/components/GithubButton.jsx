'use client'; // This directive is needed since we're using animations and interactivity

import React from 'react';

const GithubButton = () => {
  return (
    <button className="group cursor-pointer relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden scale-150 ">
